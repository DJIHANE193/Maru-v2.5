...
module.exports = {
 ...
 handlerEvents: {
    userBanned: "｢ ⛓️ ｣ ━ عذراً، تم حظركِ من استخدام البوت..\n｢ 👤 ｣ ━ المستخدم: %1\n｢ ⏳ ｣ ━ الوقت: %2\n｢ 📝 ｣ ━ السبب: %3.. 🛡",
    threadBanned: "｢ ⛓️ ｣ ━ عذراً، تم حظر هذه المجموعة من استخدام البوت..\n｢ 🆔 ｣ ━ المعرف: %1\n｢ ⏳ ｣ ━ الوقت: %2\n｢ 📝 ｣ ━ السبب: %3.. 🛡",
    onlyAdminBox: "هذه المجموعة مفعّل فيها فقط مسؤولو المجموعة يمكنهم استخدام البوت..🛡",
    onlyAdminBot: "｢ ⚠️ ｣ ━ عذراً، هذا الأمر مخصص لـ ｢ مطوّر البوت ｣ فقط.. 🫧",
    commandNotFound: "｢ 🔍 ｣ ━ الأمر الذي أدخلته غير موجود.. يمكنك كتابة [ اوامر ] لرؤية القائمة.. 🛡",
    commandNotFound2: "｢ 🚫 ｣ ━ عذراً، الأمر الذي أدخلته غير صحيح. يمكنك استخدام [ اوامر ] لمعرفة الأوامر المتاحة..🛡",
    commandSyntaxError: "｢ ❌ ｣ ━ عذراً، يبدو أن هناك خطأ في طريقة كتابة الأمر.. يرجى التحقق من ｢ الدليل ｣ الخاص به. 🛡",
    onlyAdmin: "｢ ❌️ ｣ ━ فقط مسؤولو المجموعة يمكنهم استخدام الأمر \"%1\"",
    onlyAdminToUseOnReply: "｢ ❌️ ｣ ━ فقط مسؤولو المجموعة يمكنهم استخدام وظيفة الرد على الأمر \"%1\"",
    onlyAdminToUseOnReaction: "｢ ❌️ ｣ ━ فقط مسؤولو المجموعة يمكنهم استخدام وظيفة التفاعل على الأمر \"%1\"",
    onlyAdminBot2: "｢ ❌️ ｣ ━ فقط مطوّر البوت يمكنه استخدام الأمر \"%1\"",
    onlyAdminBot2ToUseOnReply: "｢ ❌️ ｣ ━ فقط مطوّر البوت يمكنه استخدام وظيفة الرد على الأمر \"%1\"",
    onlyAdminBot2ToUseOnReaction: "｢ ❌️ ｣ ━ فقط مطوّر البوت يمكنه استخدام وظيفة التفاعل على الأمر \"%1\"",
    ...
    cannotFindCommandName: "｢ ❌️ ｣ ━ لا يمكن العثور على اسم الأمر لتنفيذ الرد!",
    cannotFindCommand: "｢ ❌️ ｣ ━ لا يمكن العثور على الأمر \"%1\" لتنفيذ هذا الرد!"
  },
  autoUptime: {
